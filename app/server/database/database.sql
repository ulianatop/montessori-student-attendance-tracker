...
/*
Truncate table resets auto increment IDS on tables for testing insert statements
*/
TRUNCATE TABLE IF EXISTS ADMIN_ACTION_TRACKING;
TRUNCATE TABLE IF EXISTS ADMIN_LOGIN;
TRUNCATE TABLE IF EXISTS ATTENDANCE_RECORD;
TRUNCATE TABLE IF EXISTS STUDENT_AUTHORIZED_ADULT;
TRUNCATE TABLE IF EXISTS AUTHORIZED_ADULT;
TRUNCATE TABLE IF EXISTS STUDENT;
TRUNCATE TABLE IF EXISTS ADMIN;
